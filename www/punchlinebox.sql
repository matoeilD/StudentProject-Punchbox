...
--
-- Client: localhost
-- Généré le: Mer 16 Mars 2016 à 17:11
...
--
CREATE DATABASE IF NOT EXISTS `punchlinebox` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `punchlinebox`;
...
CREATE TABLE IF NOT EXISTS `clashpunchline` (
...
CREATE TABLE IF NOT EXISTS `persopunchline` (
...
CREATE TABLE IF NOT EXISTS `punchlinevisiteur` (
...
CREATE TABLE IF NOT EXISTS `sexypunchline` (
...
CREATE TABLE IF NOT EXISTS `tamerepunchline` (
  `Punchline` text CHARACTER SET latin1 NOT NULL
